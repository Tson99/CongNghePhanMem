...
class Detector(object):
    ...
    def predict(self, img):
        ...
        img = np.expand_dims(img, axis=0)  # Customize this line to predict batch size

        # Normalize input data
        input_mean = 127.5
        input_std = 127.5
        input_data = (np.float32(img) - input_mean) / input_std  # range [-1, 1]
        ...
        h, w, _ = original.shape  # output in range[0, 1]
        ...
        # print(len(self.detection_classes))
